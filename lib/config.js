// Shared config helper for multi-model routing and Codex Phase 2 judge.
...
const DEFAULTS = {
  ...
  // ── Phase 2: Codex judge adapter ────────────────────────────────
  codexModel: null,
  codexTimeout: 30000,
  codexEffort: 'medium',
  enableCodexJudge: false,

  // ── Phase 3: Unified fallback judge ─────────────────────────────
  fallbackModel: 'deepseek-v4-pro',
  fallbackTimeout: 10000,
  confidenceThreshold: 0.75,
  enableFallbackJudge: false,
};
...
function loadConfig(env) {
  ...
  return {
    ...
    // ── Phase 2: Codex judge adapter ──────────────────────────────
    codexModel: e.CC_AIRLOCK_CODEX_MODEL || DEFAULTS.codexModel,
    codexTimeout: readNumber(e.CC_AIRLOCK_CODEX_TIMEOUT, DEFAULTS.codexTimeout),
    codexEffort: e.CC_AIRLOCK_CODEX_EFFORT || DEFAULTS.codexEffort,
    enableCodexJudge: readBool(e.CC_AIRLOCK_ENABLE_CODEX_JUDGE, DEFAULTS.enableCodexJudge),

    // ── Phase 3: Unified fallback judge ───────────────────────────
    fallbackModel: e.CC_AIRLOCK_FALLBACK_MODEL || DEFAULTS.fallbackModel,
    fallbackTimeout: readNumber(e.CC_AIRLOCK_FALLBACK_TIMEOUT, DEFAULTS.fallbackTimeout),
    confidenceThreshold: readNumber(e.CC_AIRLOCK_CONFIDENCE_THRESHOLD, DEFAULTS.confidenceThreshold),
    enableFallbackJudge: readBool(e.CC_AIRLOCK_ENABLE_FALLBACK_JUDGE, DEFAULTS.enableFallbackJudge),
  };
}
